...
plane
We set the camera normal as -Z w.r.t. to the camera frame to get an angle smaller than 90 degrees, since the normal will face the camera. This is done using the formula:
